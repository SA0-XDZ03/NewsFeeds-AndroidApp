...
def process_rss_feeds(category_option, option, rss_feed_file):
    ...
    for eachLine in feedRSSLineEach:
        ...
        if category_option == '1':
            with open(f"../DataSources/RSSFEED_LOGFILES/COUNTRY-{option}-{feedValue}.txt", "w", encoding="utf-8") as file:
            ...
            with open(f"../DataSources/RSSFEED_LOGFILES/SECTOR-{option}-{feedValue}.txt", "w", encoding="utf-8") as file:
                # Write the filtered articles to the text file
                for article in filteredArticle:
                    file.write("Title: " + article.title + "\n")
                    file.write("Link: " + article.link + "\n")
...
def main():
    ...
    if category_option == '1':
        ...
        if country_option == '1':
            process_rss_feeds(category_option, "Global", "../DataSources/Country-Specific/RSSFEED_GLOBAL_GENERALSOURCE.txt")
        elif country_option == '2':
            process_rss_feeds(category_option, "General", "../DataSources/Country-Specific/RSSFEED_GENERALNEWS_SOURCE.txt")
        elif country_option == '3':
            process_rss_feeds(category_option, "India", "../DataSources/Country-Specific/RSSFEED_INDIA_GENERALSOURCE.txt")
        elif country_option == '4':
            process_rss_feeds(category_option, "Pakistan", "../DataSources/Country-Specific/RSSFEED_PAKISTAN_GENERALSOURCE.txt")
        elif country_option == '5':
            process_rss_feeds(category_option, "China", "../DataSources/Country-Specific/RSSFEED_CHINA_GENERALSOURCE.txt")
        elif country_option == '6':
            process_rss_feeds(category_option, "SriLanka", "../DataSources/Country-Specific/RSSFEED_SRILANKA_GENERALSOURCE.txt")
        else:
        ...
        if sector_option == '1':
            process_rss_feeds(category_option, "Technology", "../DataSources/Sector-Specific/RSSFEED_TECHNOLOGY_GENERALSOURCE.txt")
        elif sector_option == '2':
            process_rss_feeds(category_option, "Military", "../DataSources/Sector-Specific/RSSFEED_MILITARY_GENERALSOURCE.txt")
        elif sector_option == '3':
            process_rss_feeds(category_option, "Government-Politics", "../DataSources/Sector-Specific/RSSFEED_GOVERNMENT_POLITICS_GENERALSOURCE.txt")
        elif sector_option == '4':
            process_rss_feeds(category_option, "Entertainment-Sports", "../DataSources/Sector-Specific/RSSFEED_ENTERTAINMENT_SPORTS_GENERALSOURCE.txt")
        else:
            print("Invalid option selected")
